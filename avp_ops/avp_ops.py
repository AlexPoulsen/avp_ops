...
t_div = Infix(lambda x, y: [n / y for n in x])
t_mul = Infix(lambda x, y: [n * y for n in x])
t_add = Infix(lambda x, y: [n + y for n in x])
t_sub = Infix(lambda x, y: [n - y for n in x])
t_rsub = Infix(lambda x, y: [y - n for n in x])
t_pwr = Infix(lambda x, y: [n ** y for n in x])
t_rpwr = Infix(lambda x, y: [y ** n for n in x])
t_mod = Infix(lambda x, y: [n % y for n in x])
t_rmod = Infix(lambda x, y: [y % n for n in x])
t_fmod = Infix(lambda x, y: [math.fmod(n, y) for n in x])
t_rfmod = Infix(lambda x, y: [math.fmod(y, n) for n in x])
tb_and = Infix(lambda x, y: [n & y for n in x])
tb_xor = Infix(lambda x, y: [n ^ y for n in x])
tb_or = Infix(lambda x, y: [n | y for n in x])
tb_ls = Infix(lambda x, y: [n << y for n in x])
tb_rs = Infix(lambda x, y: [n >> y for n in x])
t_sign = Infix(lambda x, y: [math.copysign(n, y) for n in x])
t_gcd = Infix(lambda x, y: [math.gcd(n, y) for n in x])
t_log = Infix(lambda x, y: [math.log(n, y) for n in x])
t_rlog = Infix(lambda x, y: [math.log(y, n) for n in x])
t_atan2 = Infix(lambda x, y: [math.atan2(n, y) for n in x])
t_ratan2 = Infix(lambda x, y: [math.atan2(y, n) for n in x])
t_hypot = Infix(lambda x, y: [math.hypot(n, y) for n in x])
t_rhypot = Infix(lambda x, y: [math.hypot(y, n) for n in x])
...
t_set = Infix(lambda x, y: [y * len(x)])
t_equ = Infix(lambda x, y: [n == y for n in x])
t_nequ = Infix(lambda x, y: [n == y for n in x])
z_equ = Infix(lambda x, y: [a == b for a, b in zip(x, y)])
z_nequ = Infix(lambda x, y: [not(a == b) for a, b in zip(x, y)])
t_not = Infix(lambda x, y: [not n for n in x])  # second term is necessary but unused
t_and = Infix(lambda x, y: [n and y for n in x])
t_nand = Infix(lambda x, y: [not(n and y) for n in x])
t_or = Infix(lambda x, y: [n or y for n in x])
t_nor = Infix(lambda x, y: [not(n or y) for n in x])
